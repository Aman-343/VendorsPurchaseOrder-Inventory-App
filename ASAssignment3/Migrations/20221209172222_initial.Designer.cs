...
namespace ASAssignment3.Migrations
{
    ...
    [Migration("20221209172222_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASAssignment3.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("ASAssignment3.Entities.InvoiceLineItem", b =>
                {
            ...
            modelBuilder.Entity("ASAssignment3.Entities.PaymentTerms", b =>
                {
                    b.Property<int>("PaymentTermsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASAssignment3.Entities.Vendor", b =>
                {
                    b.Property<int>("VendorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASAssignment3.Entities.Invoice", b =>
                {
                    b.HasOne("ASAssignment3.Entities.PaymentTerms", "PaymentTerms")
                        .WithMany("Invoices")
                        .HasForeignKey("PaymentTermsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASAssignment3.Entities.Vendor", "Vendor")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("ASAssignment3.Entities.InvoiceLineItem", b =>
                {
                    b.HasOne("ASAssignment3.Entities.Invoice", "Invoice")
