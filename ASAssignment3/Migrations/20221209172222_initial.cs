...
namespace ASAssignment3.Migrations
{
    /// <inheritdoc />
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TermPayments", x => x.PaymentTermsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_TermPayments_PaymentTermsId",
                        column: x => x.PaymentTermsId,
                        principalTable: "TermPayments",
